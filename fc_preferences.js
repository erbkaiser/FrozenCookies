FrozenCookies.preferenceValues = {
    ...
    // Pantheon options
    worshipOptions: { hint: "Pantheon options:" },
    autoWorshipToggle: {
    ...
    // Spell options
    spellOptions: { hint: "Grimoire options:" },
    towerLimit: {
    ...
    auto100ConsistencyCombo: {
        ...
        default: 0,
        confirmOnChange:
            "Are you sure? This feature is experimental and may ruin your game.",
    },
    autoSugarFrenzy: {
    ...
    // Season options
    seasonOptions: { hint: "Season options:" },
    defaultSeasonToggle: {
    ...
    // Other options
    otherOptions: { hint: "Other options:" },
    FCshortcuts: {
    ...
    fpsModifier: {
        ...
        default: 2,
        confirmOnChange:
            "Are you sure you want to change the framerate? This may cause the game to slow down.",
    },
    trackStats: {
    ...
    recommendedSettings: {
        ...
        default: 0,
        confirmOnChange:
            "Are you sure you want to apply all recommended settings? This will IMMEDIATELY reload the game.",
    },
};
